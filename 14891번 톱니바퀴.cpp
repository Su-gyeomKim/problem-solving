...
void wrotate(int w, int dir) {
	...
	case(1):
		if (w1[R] == w2[L]) {
			...
			if (w2[R] == w3[L]) {
				rotate(w1, dir), rotate(w2, -dir); break;
			}
			else if (w2[R] != w3[L]) {
				if (w3[R] == w4[L]) {
					rotate(w1, dir), rotate(w2, -dir), rotate(w3, dir); break;
				}
				else if (w3[R] != w4[L]) {
					rotate(w1, dir), rotate(w2, -dir), rotate(w3, dir), rotate(w4, -dir); break;
				}
			}
		}
	case(2):
		if (w2[L] == w1[R] && w2[R] == w3[L]) {
			...
			if (w3[R] == w4[L]) {
				rotate(w2, dir), rotate(w3, -dir); break;
			}
			else if (w3[R] != w4[L]) {
				rotate(w2, dir), rotate(w3, -dir), rotate(w4, dir); break;
			}
		}
	...
	case(3):
		if (w3[L] == w2[R] && w3[R] == w4[L]) {
			rotate(w3, dir); break;
		}

		else if (w3[L] == w2[R] && w3[R] != w4[L]) {
			rotate(w3, dir), rotate(w4, -dir); break;
		}
